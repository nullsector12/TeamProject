...
<<<<<<< HEAD
				...
				Thread.sleep(2000);
=======
				System.out.println("	3초 뒤에 마을 메뉴로 돌아갑니다.");
				System.out.println("\n\n\n\n\n\n\n");
				Thread.sleep(3000);
>>>>>>> branch 'events' of https://github.com/nullsector12/TeamProject.git
				break;
...
<<<<<<< HEAD
		Thread.sleep(500);
		System.out.println("\n\n\n");
		System.out.println("				〈Rest Inn JAVA〉");
		System.out.println("		        어서오세요, 모험가님. JAVA 여관에 오신걸 환영합니다.");
=======
		System.out.println("\n\n\n\n\n\n\n\n");
		System.out.println("			      여관〈	 Rest Inn Peace	〉");
		Thread.sleep(500);
		System.out.println("\n\n");
		Thread.sleep(500);
		System.out.println("		여관에 들어섭니다. 한 종업원이 플레이어를 발견하고 다가옵니다.");
>>>>>>> branch 'events' of https://github.com/nullsector12/TeamProject.git

		while (true) {
<<<<<<< HEAD

			System.out.println("				어떤 종류의 방을 원하시나요?");
=======
			System.out.println("\n\n");
			Thread.sleep(500);
			System.out.println("		   종업원 : 어서오세요, 손님! 어떤 종류의 방을 원하시나요?");
>>>>>>> branch 'events' of https://github.com/nullsector12/TeamProject.git
			System.out.println();
<<<<<<< HEAD
			System.out.println("	┏===============================================================┓");
			...
			System.out.println("	│								│");
			System.out.println("	┗===============================================================┛");
			System.out.println("	소지금 :" + d.p.getGold());
=======
			Thread.sleep(500);
			System.out.println("	+===============================================================+");
			System.out.println("	│ 							    	│");
			...
			System.out.println("	│						            	│");
			System.out.println("	+===============================================================+");
			System.out.println("	소지금 : " + d.p.getGold() + " Gold");
			System.out.println("\n\n");
...
<<<<<<< HEAD
					...
					Thread.sleep(500);
=======
					System.out.println("	이런! 소지금이 부족합니다.");
>>>>>>> branch 'events' of https://github.com/nullsector12/TeamProject.git
